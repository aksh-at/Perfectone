...
from numpy import arange, sin, pi, sqrt,median
...
def Final():
    ...
    RT_label.config(text="RT value is greater than the worst configuration by "+str((final[-1][1][0]-final[0][1][0])*1000)+" milliseconds")
    SS_label.config(text="Sound Strength is greater than the worst configuration by "+str(final[-1][1][2]-final[0][1][2])+" units")
